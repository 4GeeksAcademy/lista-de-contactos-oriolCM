...
export const Home = () => {
	...
	return (
		<div className="container border rounded px-0">
			...
			<div className="d-flex mt-3">{/*Div contacto 1 */}
			...
			<hr />
			<div className="d-flex mt-3">{/*Div contacto 2 */}
			...
			<hr />
			<div className="d-flex mt-3">{/*Div contacto 3 */}
			...
			<hr />
			<div className="d-flex mt-3">{/*Div contacto 4 */}
